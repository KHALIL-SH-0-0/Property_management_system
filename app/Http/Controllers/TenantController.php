...
class TenantController extends Controller
{
    ...
    $user->flatOrders()->attach($request->flat_id, [
...
public function buyFlat(Request $request) {
    ...
    $user->flatOrders()->updateExistingPivot($request->flat_id, [
        'start_date' => $request->start_date,
        'end_date' => $request->end_date,
        'status' => 'Pending',
    ]);
...
public function cancelReservation(Request $request)
{
    ...
    $user->flatOrders()->detach($request->flat_id);
    ...
    $bookings = $user->flatOrders->map(function ($flat) {
        return [
            'flat_id'=> $flat->id,
